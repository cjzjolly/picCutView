...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**上一次选中的条目**/
    private ViewHolder mPrevCheckedItem = null;
...
//        }
        ...
        if (/*config.enablePreview || config.enPreviewVideo || config.enablePreviewAudio*/true) {
            contentHolder.btnCheck.setOnClickListener(v -> { //cjzmark 选择图片
                Log.i("cjztest", "PictureImageGridAdapter.选中图片:" + v);
                //cjzmark todo 去除上次选中的对勾
...
//                tvCheck.setBackgroundResource(R.drawable.picture_checkbox_selector);
