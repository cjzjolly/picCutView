...
//        this.setAnimationStyle(R.style.PictureThemeWindowStyle); //cjztest 暂时不要外观了
        this.setFocusable(true);
        this.setOutsideTouchable(true);
        this.update();
//        if (PictureSelectionConfig.uiStyle != null) {//cjztest 暂时不要外观了
...
//        }
    ...
    public void showAsDropDown(View anchor) {
        try {
            ...
            isDismiss = false;
//            AnimUtils.rotateArrow(ivArrowView, true); //cjztest 这个动画有利用价值
            rootViewBg.animate()
                    .alpha(1)
                    .setDuration(250)
